            ...
            children: <Widget>[
              Row(
                children: <Widget>[
                  ...
                  _MiniPlayerPlaybackButton(controller: controller),
                  IconButton(
              ...
              Positioned(
                ...
                right: 0,
                bottom: 0,
                child: _MiniPlayerProgressBar(controller: controller),
              ),
            ],
          ),
        ),
...
class _MiniPlayerPlaybackButton extends StatelessWidget {
  const _MiniPlayerPlaybackButton({required this.controller});
    ...
    return Obx(() {
      ...
      return IconButton(
        ...
        style: IconButton.styleFrom(
          backgroundColor: context.colors.secondary.withValues(alpha: 0.18),
        ),
      );
    });
  }
